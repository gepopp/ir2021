...
<?php else: ?>
	...
	<?php $FormSession->flashErrorBag( 'global_error' ) ?>
    ...
    <form method="post" action="<?php echo admin_url( 'admin-post.php' ) ?>" enctype="multipart/form-data" class="w-full" id="zur-person-update">
        ...
        <div class="mb-5 pb-3 border-b border-primary-100 grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
                ...
                <input type="text" name="firstname" class="w-full p-3"/>
            </div>
            <div>
                <h3 class="mb-3">Nachname</h3>
                <input type="text" name="lastname" class="w-full p-3"/>
            </div>
        </div>
        <div class="mb-5 pb-3 border-b border-primary-100 grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
                <h3 class="mb-3">Untenehmen</h3>
                <input type="text" name="company" class="w-full p-3"/>
            </div>
            <div>
                <h3 class="mb-3">Position</h3>
                <input type="text" name="position" class="w-full p-3"/>
            </div>
        </div>

        <div class="mb-5 pb-3 border-b border-primary-100">
            <h3 class="mb-3">Personenbeschreibung / Karriereschritte</h3>
            <textarea name="description" class="w-full p-3" rows="10"></textarea>
        </div>

        <div class="mb-5 pb-3 border-b border-primary-100">
            <h3 class="mb-3">Link zur Ihrer Webseite</h3>
            <input type="url" name="companylink" class="w-full p-3" value="">
        </div>
        <div class="mb-5 pb-3 border-b border-primary-100">
