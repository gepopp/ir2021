    ...
    <div class="container mx-auto p-5 mt-20">
        ...
        <div class="text-center mb-10">
            <h1 class="inline text-cent font-serif text-3xl font-semibold"
                style="background: linear-gradient(0deg, <?php the_field('field_613b5990f3543', 'option'); ?> 0%, <?php the_field('field_613b5990f3543', 'option'); ?> 50%, transparent 50%, transparent 100%);">Aktuelle Presse</h1>
        </div>
