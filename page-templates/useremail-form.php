<div class="col-span-3 lg:col-span-1 lg:h-full mt-24 lg:mt-0">
    <h1 class="text-2xl font-serif font-semibold"><?php __('E-Mail Adresse', 'ir21') ?></h1>
    <div class="bg-white shadow-md px-8 pt-6 pb-8 mb-4 h-full"
         x-data="alterEmail()">
        <div>
            <label class="block text-gray-700 text-sm font-bold mb-2"><?php __('Aktuelle E-Mail Adresse:', 'ir21') ?></label>
        ...
        <div x-show="!pinSent">
            <label class="mt-4 block text-gray-700 text-sm font-bold mb-2" for="new_email"><?php __('Neue E-Mail Adresse', 'ir21') ?></label>
