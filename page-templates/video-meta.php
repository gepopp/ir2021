<div class="text-white flex justify-between w-full mt-5">
    ...
    <div>
        <?php get_template_part('page-templates/video', 'iconbar') ?>
    </div>
    <div class="flex mt-2">
        <div class="flex" x-data="readTime('<?php echo preg_replace("/[^ A-Za-z0-9?!]/", '', str_replace('"', '', wp_strip_all_tags(get_the_content()))); ?>')">
            <svg class="mr-3 w-6 h-6 text-white inline" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
