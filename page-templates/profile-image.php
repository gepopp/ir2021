...
<div class="col-span-3 lg:col-span-1">
    ...
    <form enctype="multipart/form-data" class="bg-white shadow-md px-8 pt-6 pb-8 mb-4 h-full" method="post" action="<?php echo admin_url('admin-post.php') ?>" x-data="profileImage('<?php echo $image['sizes']['thumbnail'] ?>')">
