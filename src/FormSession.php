...
class   FormSession
{
    ...
    protected function setupMessages()
    {
        $this->messages = [
            ...
            'token_expired'         => sprintf('Dieser Link ist nicht mehr gültig, Sie können über die <a href="%s">Passwort vergessen</a> funktion ein neues E-Mail anfordern', get_field('field_601e59c9336d7', 'option')),
